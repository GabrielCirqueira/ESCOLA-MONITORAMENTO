    ...
    <div class="container">
        <div class="header" style="text-align: center;">
            ...
            <h2 style="font-size: 13pt;">
                <?php foreach ($turmas as $idx => $turma) {
                    echo ($idx > 0 ? ' - ' : '') . $turma;
                } ?>
            </h2>
        </div>
        ...
        <div class="content">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="1" rowspan="1">
                            ...
                            <span style="font-weight: 700;"><?= $simulado['area_conhecimento'] ?></span>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="1" rowspan="1">
            ...
            <div>
                ...
                <div class="area-orientacao"><?= $simulado['orientacoes'] ?></div>
            </div>
                        ...
                        <?php foreach($provas as $prova): ?>
                            ...
                            ">
                                <h4 style="
                                    ...
                                    text-align: left;
                                ">
                                    <?php #echo ucwords(mb_strtolower($prova["disciplina"])); ?>
                                    <?php echo ucwords(mb_strtolower($prova["nome_prova"])); ?>
                                </h4>

                                <table class="table-grid" style="display: inline-table; border: 2px solid #000000; padding: 0;">
                                    <tbody>
