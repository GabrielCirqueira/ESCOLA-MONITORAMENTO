<div class="container-gestor-info">
    ...
    <form action="adicionar_materia" method="post" class="formulario-add-professor">
        ...
        <div class="campo-formulario-add">
            ...
            <input type="text" id="nome" name="nome-materia" class="input-add" required>
        </div>
        ...
        <div class="campo-formulario-add">
            <div>
                ...
                <input type="checkbox" class="input-checkbox" name="turno-materia[]" value="INTERMEDIÁRIO"> <span>INTERMEDIÁRIO</span><br>
                <input type="checkbox" class="input-checkbox" name="turno-materia[]" value="VESPERTINO"> <span>VESPERTINO </span> <br>
                <input type="checkbox" class="input-checkbox" name="turno-materia[]" value="NOTURNO"> <span> NOTURNO</span> <br>
                    <br>
            </div>
        </div>
