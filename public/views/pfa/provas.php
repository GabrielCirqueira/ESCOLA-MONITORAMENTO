<main class="main-home-professor">
    ...
    <form id="filterFormProva" action="" method="post">
        <button name="geral" class="button-vsGeral" value="geral">GERAL</button>
    ...
    if($data["geral"] == False){?>
        ...
        <div class="filtros_exibir">
            <?php foreach ($data["filtros"] as $filtro => $value) {
                if ($value != NULL && $filtro != "disciplina" && $filtro != "datas" && $filtro != "turno") { ?>
                    <div>
    ...
    ?>
            ...
            <div class="prova-pendente" style="width:85%" >
                ...
                <div class="conteudo-prova">
                    ...
                    <?php if ($status == true) { ?>
                        <form method="post" action="pfa_prova">
